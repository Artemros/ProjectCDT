            ...
            if (globalFlag) {
                ...
                if (globalFlag) {
                    if (answer == 0) {
                        ...
                        } else if (sequence.length() >= 1 && sequence.length() <= 100) {
                            boolean flag = true;
//                            for (int i = 0; i < sequence.length(); i++) {
//                                if (!intSymbols.contains(sequence.charAt(i)) && !plus.contains(sequence.charAt(i)) && !left.contains(sequence.charAt(i)) && !right.contains(sequence.charAt(i)) && !dot.contains(sequence.charAt(i))) {
